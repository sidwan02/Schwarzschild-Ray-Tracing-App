...
function Trace3D(props) {
        ...
        if (flag_no_periastron) {
          setStateGraph({
            ...
            layout: {
              ...
              title: 'Ray Trace from (' + x_trace[0].toFixed(2) + ', '
                + y_trace[0].toFixed(2) + ', '
                + z_trace[0].toFixed(2) + ') <br>with initial velocity <'
                + alpha0.toFixed(2) + '°, ' + beta0.toFixed(2) + '°, '
                + gamma0.toFixed(2) + '°>',
              legend: {
                yanchor: "top",
                y: 0.99,
  ...
  const clickManualEntryBtn = () => {
    if (xManual === null || xManual === '') {
      ...
      && (beta0Manual === null || beta0Manual === '')
      && (gamma0Manual !== null || gamma0Manual !== '')) {
      let term = (1 - Math.cos(alpha0Manual * Math.PI / 180) ** 2
      ...
      if (term < 0) {
        ...
        requestRayTrace(xManual, yManual, zManual, alpha0Manual, Math.acos(Math.sqrt(term))
          * 180 / Math.PI, gamma0Manual)
      }

    } else if ((alpha0Manual === null || alpha0Manual === '')
      && (beta0Manual !== null || beta0Manual !== '')
      && (gamma0Manual !== null || gamma0Manual !== '')) {
      let term = (1 - Math.cos(beta0Manual * Math.PI / 180) ** 2
        - Math.cos(gamma0Manual * Math.PI / 180) ** 2)
      term = Number(term.toFixed(5))
      if (term < 0) {
        ...
        requestRayTrace(xManual, yManual, zManual, Math.acos(Math.sqrt(term))
          * 180 / Math.PI, beta0Manual, gamma0Manual)
      }

    } else if ((alpha0Manual !== null || alpha0Manual !== '')
      && (beta0Manual !== null || beta0Manual !== '')
      && (gamma0Manual !== null || gamma0Manual !== '')) {
      if (Math.abs((1 - Math.cos(beta0Manual / 180 * Math.PI) ** 2
